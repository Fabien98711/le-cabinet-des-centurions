    ...
    <form action="time_appt.php" method="post" class="max-w-md mx-auto mt-8 bg-white p-8 rounded-lg shadow-lg flex flex-col">
    <label for="date" class=" p-2 ">Date :</label>
    <input type="date" id="date" name="date" required class="mt-2 w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500"><br>
